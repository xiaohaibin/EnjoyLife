...
public class VideoListAdapter extends BaseAdapter {
    ...
    public VideoListAdapter(Context mContext, List<VideoResponse.IssueListEntity.ItemListEntity> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            ...
            default:
                ...
                //设置布局
                convertView = LayoutInflater.from(mContext).inflate(R.layout.list_home_video_item, parent, false);
                if (convertView == null) {
